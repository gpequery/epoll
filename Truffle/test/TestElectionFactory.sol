...
//            var (a1, b1, c1, d1, e1, f1, g1, h1) = getCandidateById(electionId, candidateId);
//            Assert.equal(a1, true, "Should return true");
//            Assert.equal(d1, candidateName, "Should return the candidate name");
//
            var (a10, b10, c10, d10, e10, f10, g10, h10) = getCandidateById(electionId,0xe1009458C3DEFffBb97A778615820a81809Ffdb5);
            Assert.equal(a10, false, "Should return false");
